...
public class ReadDataStudent{
    ...
    public double[] standardUnits(double[] arr){
        ...
        double mean = mean(arr);
        for(int index = 0; index < arr.length; index++){
            stdArr[index] = (arr[index] - mean)/stdDeviation;
        }
        return stdArr;
    }
    ...
    public double correlation(double[] x, double[] y){
        ...
        double xProduct = 1;
        double yProduct = 1;
        double[]standardUnitsX = standardUnits(x);
        double[]standardUnitsY = standardUnits(y);
        for(int index = 0; index < standardUnitsX.length; index++){
            xProduct = xProduct*standardUnitsX[index];
        }
        for(int index = 0; index < standardUnitsY.length; index++){
            yProduct = yProduct*standardUnitsY[index];
        }
        ...
        return ...;    
    }
